@echo off
REM Auto-generated script to build executable for Employee_Engagement_Pulse
...
echo === Build Complete ===
echo Executable location: dist\employee_engagement_pulse.exe
echo Run with: .\dist\employee_engagement_pulse.exe
